...
public class ObTableClientTestUtil {
    public static String FULL_USER_NAME          = "root@mysql#ob11.shenyunlong.syl.11.158.77.144";
    public static String PARAM_URL               = "http://ocp-cfg.alibaba.net:8080/services?User_ID=alibaba&UID=test&Action=ObRootServiceInfo&ObCluster=ob11.shenyunlong.syl.11.158.77.144&database=test";

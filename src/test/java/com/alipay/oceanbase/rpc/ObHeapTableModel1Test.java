...
/*
 * 表模型1：普通非分区无主键堆表
 * CREATE TABLE test_heap_model1 (
 *  c1 bigint, 
 *  c2 varchar(20), 
 *  c3 bigint
 * ) ORGANIZATION = HEAP;
 */
public class ObHeapTableModel1Test {
    ObTableClient        client;
    public static String tableName = "test_heap_model1";
    ...
    public void testSingleGet() throws Exception {
        ObTableException thrown = assertThrows(
                ...
                () -> {
                    ...
                    .setRowKey(row(colVal("spk", 1001L)))
                    .select("c1", "c2")
                    .execute();
                }
        );
    ...
    public void testScan1() throws Exception {
        try {
            ...
            for (int i = 1; i <= 3; i++) {
                ...
                insert.setPartitionKey(row(colVal("spk", (long) (2000 + i)))).addMutateColVal(
            ...
            while (res1.next()) {
                ...
                assertEquals("c1 should match", (long) (2000 + count1), valueMap.get("c1"));
                assertEquals("c2 should match", "batch_test", valueMap.get("c2"));
                assertEquals("c3 should match", (long) (3000 + count1), valueMap.get("c3"));
            }
            ...
            while (res2.next()) {
                ...
                assertEquals("c1 should match", (long) (2000 + count2), valueMap.get("c1"));
                assertEquals("c2 should match", "batch_test", valueMap.get("c2"));
                assertEquals("c3 should match", (long) (3000 + count2), valueMap.get("c3"));
            }
    ...
    public void testBatchInsert1() throws Exception {
        try {
            ...
            while (res.next()) {
                count++;
                Map<String, Object> valueMap = res.getRow();
                assertEquals("c1 should match", (long) (2000 + count), valueMap.get("c1"));
                assertEquals("c2 should match", "batch_test" + count, valueMap.get("c2"));
                assertEquals("c3 should match", (long) (3000 + count), valueMap.get("c3"));
            }
    ...
    public void testBatchInsertOrUpdate1() throws Exception {
        try {
            ...
            for (int i = 1; i <= 3; i++) {
                ...
                insertOrUpdate.setPartitionKey(row(colVal("spk", 1001L))).addMutateColVal(
                    colVal("c1", (long) (2000 + i)), colVal("c2", "batch_test" + i),
                    colVal("c3", (long) (3000 + i)));
        ...
        ObTableException thrown = assertThrows(
                ...
                () -> {
                    ...
                    for (int i = 1; i <= 3; i++) {
                        ...
                        get.setRowKey(row(colVal("spk", 1001L)))
                            .select("c1", "c2", "c3");
        ...
        ObTableException thrown = assertThrows(
                ...
                () -> {
                    ...
                    for (int i = 1; i <= 3; i++) {
                        ...
                        update.setPartitionKey(row(colVal("spk", 1001L)))
        ...
        ObTableException thrown = assertThrows(
                ...
                () -> {
                    ...
                    for (int i = 1; i <= 3; i++) {
                        ...
                        delete.setPartitionKey(row(colVal("spk", 1001L)));
        ...
        ObTableException thrown = assertThrows(
                ...
                () -> {
                    ...
                    for (int i = 1; i <= 3; i++) {
                        ...
                        increment.setPartitionKey(row(colVal("spk", 1001L)))
                            .addMutateColVal(colVal("c1", 1001L), colVal("c2", "batch_test1"), colVal("c3", 2001L));
        ...
        ObTableException thrown = assertThrows(
                ...
                () -> {
                    ...
                    for (int i = 1; i <= 3; i++) {
                        ...
                        append.setPartitionKey(row(colVal("spk", 1001L)))
                            .addMutateColVal(colVal("c1", 1001L), colVal("c2", "batch_test1"), colVal("c3", 2001L));
        ...
        ObTableException thrown = assertThrows(
                ...
                () -> {
                    ...
                    for (int i = 1; i <= 3; i++) {
                        ...
                        put.setPartitionKey(row(colVal("spk", 1001L)))
                            .addMutateColVal(colVal("c1", 1001L), colVal("c2", "batch_test1"), colVal("c3", 2001L));

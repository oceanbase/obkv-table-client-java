 ...
 */
public class ObHeapTableModel3Test {
    ObTableClient        client;
    public static String tableName = "test_heap_model3";
    ...
    public void testSingleInsert2() throws Exception {
        try {
            ...
            assertTrue(thrown.getMessage().contains("[-5024][OB_ERR_PRIMARY_KEY_DUPLICATE][Duplicate entry '1001' for key 'c1']"));
        } finally {
            // 清理数据
            truncateTable();
        }

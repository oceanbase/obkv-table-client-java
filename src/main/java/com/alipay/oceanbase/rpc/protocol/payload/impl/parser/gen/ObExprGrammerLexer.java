...
public class ObExprGrammerLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"ID", "WS", "DECIMAL_LITERAL", "IDEN_LITERAL", "DIGIT", "LETTER", "EXPONENT_NUM_PART"
		};
	}
	...
	public ObExprGrammerLexer(CharStream input) {
		super(input);

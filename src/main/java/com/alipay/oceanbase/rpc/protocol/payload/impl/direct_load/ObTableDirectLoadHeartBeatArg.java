...
public class ObTableDirectLoadHeartBeatArg implements ObSimplePayload {

    private long tableId = 0;
    private long taskId  = 0;

    public ObTableDirectLoadHeartBeatArg() {
    }
     ...
     */
    @Override
    public ObTableDirectLoadHeartBeatArg decode(ByteBuf buf) {

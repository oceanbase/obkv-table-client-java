...
public class ObTableDirectLoadHeartBeatRes implements ObSimplePayload {
    ...
    public ObTableDirectLoadHeartBeatRes() {
    }
     ...
     */
    @Override
    public ObTableDirectLoadHeartBeatRes decode(ByteBuf buf) {

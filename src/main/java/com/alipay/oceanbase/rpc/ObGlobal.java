...
public class ObGlobal {
    ...
    public static long calcVersion(int major, short minor, byte major_patch, byte minor_patch) {
        return ((long) major << OB_VSN_MAJOR_SHIFT) + ((long) minor << OB_VSN_MINOR_SHIFT) + ((long) major_patch << OB_VSN_MAJOR_PATCH_SHIFT) + ((long) minor_patch << OB_VSN_MINOR_PATCH_SHIFT);
    }
    public static long calcVersion(long major, long minor, long major_patch, long minor_patch) {
        return major << OB_VSN_MAJOR_SHIFT + minor << OB_VSN_MINOR_SHIFT + major_patch << OB_VSN_MAJOR_PATCH_SHIFT + minor_patch << OB_VSN_MINOR_PATCH_SHIFT;
    }

...
public class IncrementResult extends MutationResult<IncrementResult> {
     ...
     */
    public IncrementResult(ObPayload result) {
        super(result);
        row = null;
    }

    /*
     * get the affected row of mutation ( simple -> Object not ObObj )
     * TODO: result of mutation with filter / withResult in server
     */
    public Row getResultRowSimple() {
        return null;
    }

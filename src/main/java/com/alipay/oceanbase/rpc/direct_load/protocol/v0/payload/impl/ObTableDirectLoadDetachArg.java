...
public class ObTableDirectLoadDetachArg implements ObSimplePayload {

    private long tableId = 0;
    private long taskId  = 0;

    public ObTableDirectLoadDetachArg() {
    }
     ...
     */
    @Override
    public ObTableDirectLoadDetachArg decode(ByteBuf buf) {

...
import com.alipay.oceanbase.rpc.direct_load.protocol.v0.payload.impl.ObTableDirectLoadCommitArg;
...
public class ObDirectLoadCommitRpcV0 extends ObDirectLoadDefaultRpcV0 implements
                                                                     ObDirectLoadCommitRpc {

    public static final ObTableDirectLoadOperationType OP_TYPE = ObTableDirectLoadOperationType.COMMIT;

    private ObTableDirectLoadCommitArg                 arg     = new ObTableDirectLoadCommitArg();

    public ObDirectLoadCommitRpcV0(ObDirectLoadTraceId traceId) {
        super(traceId);
    }

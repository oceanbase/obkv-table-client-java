...
import static com.alipay.oceanbase.rpc.dds.parser.DistributeRuleCharType.*;
import static com.alipay.oceanbase.rpc.dds.parser.DistributeRuleSimpleToken.*;

/**
 * @author zhiqi.zzq
 * @since 2018/8/21 下午11:18
 */
public class DistributeRuleLexer {

    private final String                text;
    protected char                      ch;
    private int                         pos;
    private int                         mark;
    protected DistributeRuleSimpleToken token;
    protected char[]                    buf;
    private int                         bufPos;
     ...
     */
    public DistributeRuleLexer(String text) {
        this.text = text;
        this.pos = -1;
        scanChar();
        nextToken();
    ...
    public void scanHexaDecimal() {
        ...
        for (;;) {
            if (DistributeRuleCharType.isHex(ch)) {
                bufPos++;
            } else {
                break;
            }
     ...
     * Token.
     */
    public DistributeRuleSimpleToken token() {
        return token;
    }

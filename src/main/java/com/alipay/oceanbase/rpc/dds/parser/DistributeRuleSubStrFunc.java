 ...
 */
public class DistributeRuleSubStrFunc implements DistributeRuleSimpleFunc {
    ...
    public void setParameters(List<Object> parameters) throws IllegalArgumentException {
        if (parameters.size() < 2) {
            throw new IllegalArgumentException("substr argument size must be bigger than 2 "
                                               + parameters);
        }
